...
import com.csr.masterapp.device.AboutFragment;
...
import com.csr.masterapp.device.SecuritySettingsFragment;
import com.csr.masterapp.device.TemperatureFragment;
...
public class SimpleNavigationListener implements ActionBar.OnNavigationListener {
    ...
    public SimpleNavigationListener(FragmentManager fragmentManager, Activity activity) {
        ...
        mActivity = activity;
        activity.setContentView(R.layout.content);
