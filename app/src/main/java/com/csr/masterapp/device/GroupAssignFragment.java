...
import com.csr.masterapp.device.CheckedListFragment.ItemListener;
...
implements ItemListener, GroupListener, InfoListener, RemovedListener, DataListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView)mRootView.findViewById(R.id.header_tv_title)).setText(mResources.getString(R.string.device_management));
        mRootView.findViewById(R.id.header_btn_ok).setVisibility(View.GONE);
        mRootView.findViewById(R.id.header_iv_back).setOnClickListener(new OnClickListener() {
            @Override
