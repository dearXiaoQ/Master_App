...
public class SingleDevice extends Device implements Serializable {
	...
	public String toString() {
		return "mUuidHash = " + mUuidHash + "  mShortName = " + mShortName + "  uuid = " + uuid;
	}
	...
	public SingleDevice(int deviceId, String uuid, int uuidHash, String name, String shortName,
	...
	public SingleDevice(SingleDevice other) {
		...
		this.mShortName = other.mShortName;
	 ...
	 * @return True if the device supports all specified models.如果设备支持所有指定的模型，则是真的。
	 */
