 ...
 *
 */
public class SSensorFragment extends Fragment implements TemperatureListener{

    private final static String TAG = "SSensorFragment";
    ...
    public void onStart() {
        ...
        mWebView.loadUrl("file:///android_asset/index-oilSensor.html");
    }
    ...
    public void onResume() {
        super.onResume();
        List<Device> devices = mController.getDevicesByShortName("SSensor");
    ...
    public void setCurrentStatus(String data) {
        ...
        try {
            tempData = tempData/17;
        } catch (NumberFormatException e) {
            e.printStackTrace();
        }
        Log.d(TAG, "getTempData: 接收粉尘数据是" + tempData + "");
        mValue.setText(data);
        mWebView.loadUrl("javascript:getOilData(" + tempData + ")");
    }
