 ...
 *
 */
public class RHoodControlFragment extends Fragment implements TemperatureListener, View.OnClickListener {

    private final static String TAG = "RHoodControlFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.rhood_control_fragment, container, false);
    ...
    public void onStart() {
        ...
        mWebView.addJavascriptInterface(new JavaScriptInterface(getActivity()), "RHoodObject");
        mWebView.loadUrl("file:///android_asset/index-hoops.html");
    }
    ...
    public void setCurrentStatus(String data) {
        ...
        switch (data){
            ...
            case "0a00"://快
                status = 3;
                Log.d(TAG, "setCurrentStatus: 更新了状态快");
                break;
            case "0c00"://慢
                status = 4;
                Log.d(TAG, "setCurrentStatus: 更新了状态慢");
                break;
        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button1:
                setNewValue(0x000c,true);
                break;
            case R.id.button2:
                setNewValue(0x000f,true);
                break;
            case R.id.button3:
                setNewValue(0x000a,true);
                break;
            case R.id.button4:
                setNewValue(0x000c,true);
                break;
    ...
    private class JavaScriptInterface {
        ...
        @JavascriptInterface
        public void controlRHood(int param) {
            float value = 0;
            switch (param){
                case 1://开
                    value = 0x000c;
...
//        }
    ...
    public void onResume() {
        ...
        List<Device> devices = mController.getDevicesByShortName("RHood");
